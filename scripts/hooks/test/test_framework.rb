...
module TestData
  ...
  BLOCKED_PATHS = [
    ...
    { input: '~/.ssh/id_ecdsa', expected: :blocked },
    { input: '~/.ssh/id_dsa', expected: :blocked },
    { input: '~/.ssh/control.sock', expected: :blocked },
    ...
    { input: '~/.gnupg/private-keys-v1.d/key', expected: :blocked },
    { input: '~/.private_keys/AuthKey.p8', expected: :blocked },
    { input: '~/.config/nv/env', expected: :blocked },
    ...
    { input: '/app/.env.local', expected: :blocked },
    { input: '/app/private.pem', expected: :blocked },
  ...
  # 15 allowed paths
  ALLOWED_PATHS = [
    { input: '~/.ssh/config', expected: :allowed },
    { input: '~/.ssh/config.d/saneapps-mini.conf', expected: :allowed },
    { input: '~/.ssh/known_hosts', expected: :allowed },
    { input: '~/.ssh/authorized_keys', expected: :allowed },
    { input: '~/.ssh/id_ed25519.pub', expected: :allowed },
    { input: '/etc/passwd', expected: :allowed },
    { input: '/etc/hosts', expected: :allowed },
    { input: '/usr/bin/ruby', expected: :allowed },
    { input: '/usr/lib', expected: :allowed },
